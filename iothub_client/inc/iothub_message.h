...
*
*            @b NOTE: Generally, property key names and values can only contain ASCII alphanumeric characters, 
*            plus {'!', '#', '$', '%, '&', ''', '*', '+', '-', '.', '^', '_', '`', '|', '~'}. However, the accepted  
*            character sets are dependent on other factors such as the protocol being used. For more information
*            on the character sets accepted by Azure IoT Hub, see <a href="https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messages-construct">Create and read IoT Hub messages</a>.
*
